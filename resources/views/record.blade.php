...
<div class="container-fluid">
   ...
   <div class="row" text-center>
      <p class="">
         <b> Ref no.</b> <input type="text" style="font-size:xx-large;">
   ...
   <div class="row" style="border-top: 1px solid grey; padding-top:5px;">
      <div class="col-6">
         ...
         <p><b> Name:</b><input type="text" style="width:500px;">
            <p><b>Job Title:</b> <input type="text"></p>
         </p>
         <p><b>DOB:</b> <input type="text"> <br>
            <p><b>Gender:</b> <input type="checkbox"> Male <input type="checkbox"> Female </p>
         </p>
      </div>
      <div class="col-4">
   ...
   <div class="row" style="border-top: 2px solid grey; padding-top:5px;">
      ...
      <div class="col-6">
         ID related number: <input type="text" style="width:250px;">
      </div>
      <div class="col-12">
      ...
      <div class="row" style="padding-bottom:5px; ">
         <div class="col-3" style="padding-left:50px;">Print name: <input type="text"></div>
         <div class="col-3" style="padding-left:50px;">Signature: <input type="text"></div>
         <div class="col-3" style="padding-left:50px;">Relationship to Donor: <input type="text"></div>
         <div class="col-3" style="padding-left:50px;">Employer: <input type="text"></div>
      </div>
   </div>
         ...
         <div class="row">
            ...
            <div class="col-3">
               <p style="font-size:x-small" class="text-center">
                  Breathalyzer Calibration Date: <br><input type="text" style="width:150px;"> </p>
      ...
      <div class="row">
         <div class="col-12">
            <div class="container">
               <div class="row">
                  <div class="col-4">
                     <p style="font-size:small;">Sample temperature range (32-38 deg) <input type="checkbox"
                           style="margin-left:15px; margin-right:5px;"> YES
                  </div>
                  <div class="col-8" style="font-size:x-small">
                     Drug kit Lot no. <input type="text"><input type="text"> Drug kit Expiry Date: <input type="text">
                     </p>
                  </div>
               </div>
