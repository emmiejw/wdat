...
<p>
    ...
    understand that a chain of custody maybe performed in light of a non-negative drugs screen and give consent for my
    sample to be laboratory tested to confirm the results of any initial analysis undertaken. I hold the individuals and
    testing companies involved within this procedure blameless against any loss or damage, direct or indirect, for
    either the results obtained or for any action arising or taken by any person in receipt of this information.
</p>
<div class="form-group">
    <label for="sample_donor_sig">Signature</label>
    <br>
    <section class="signature-component">
        <canvas id="signature-pad" width="500" height="75" name="sample_donor_sig"></canvas>
    </section>
    <br><br>
