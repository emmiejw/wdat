<div class="row">
        ...
        <ol class="flow-text">
            <li>Up to <b>14 million work days</b>  are <b>lost </b> each year, due to alcohol use. </li>
            <li><b>Sickness absence</b>  costs employers an estimated  <b>£3 billion</b>  a year.</li>
            <li>Up to <b>25%</b>  of all workplace <b> accidents </b>and <b>60% </b> of <b>fatal accidents </b> were attributed to <b>alcohol</b>  (2016-2017).</li>
            <li>Up to <b>75% </b> of people who claim to have a problem with alcohol <b>are in employment</b>. </li>
            <li>In the UK, <b>100, 000</b>  people were <b>convicted</b>  for drink driving, most said "I feel ok to drive".</li>
            <li>The cost to  employers for drug and alcohol misuse are enormous and can significantly affect organic growth, <b>profitability</b> , stability and <b>reputation</b> . </li>
            <li>Studies show <b>1 in 12</b>  (8.5%) 16 to 59 year olds admitted to taking illicit drugs. Further <b>1/4</b>  of 26-30 year olds have tried <b>class A drugs</b>  such as; heroine, cocaine or ecstasy at least once.</li>
            <li>Of the people seeking help for drug misuse, <b>25%  are employed</b>  (this doesn't include those who have already sought help).</li>
            <li>Of the large companies surveyed <b>18%</b>  had reported <b>illegal drug use</b>.</li>
            <li>Finally, drugs and alcohol misuse that is not addressed, can undermine Health and Safety in the Workplace and potentially lead to experiencing litigation. Employers are not only responsible for their own safety but also that of their entire workforce.</li>
          </ol>
        </p>
        <b class="flow-text">Contact us and we can discuss how we can support you in identifying drugs and alcohol misuse in the workplace.</b>
        </div>
    </div>
<div class="row">
    <div class="col s5 l4 offset-l1 push-l7">
        <img src="images/bevshots.png" alt="" class="responsive-img materialboxed assess">
    </div>
...
<div class="row">
    ...
    <div class="col s7 l6 offset-l1 pull-l5 right-align">
        ...
        <ol  class="flow-text">
            <li >The donor is happy with this result, is therefore in agreement with the substances found in their urine and signs the declaration form.</li>
            <li>A re-test is requested ( at a further cost).</li>
            <li>A full chain of custody laboratory test is performed to finalise the result ( please note this incurs a further fee per individual drug tested). </li>
        </ol>
        <p  class="flow-text">
                ...
                As a company you will need to make a safety concious judgement (which must be reflected and explicitly written in your Drugs and Alcohol Policy) the level at, which employees are fit for work, significant amount of companies set it at 22mg per 100ml of breath, please not this is NOT applicable or suitable for employees working on railways, tramways and any other guided transport system, where guidance states the breathalyser levels should be 0 .
        </p>
        </p>
        <br>
        <b class="flow-text">Contact us and we can recommend the appropriate drugs and alcohol testing methods and frequency that is most suitable for your company and workforce.</b>
    </div>
</div>
</section>